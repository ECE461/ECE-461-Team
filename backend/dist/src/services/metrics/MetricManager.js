...
class MetricManager {
    ...
    getMetrics() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            startTime = perf_hooks_1.performance.now();
            let pullRequestMetric = new PullRequest_1.PullRequest(this.owner, this.repoName);
            let pullRequestValue = yield pullRequestMetric.getPullRequest();
            let pullRequestLatency = (perf_hooks_1.performance.now() - startTime);
