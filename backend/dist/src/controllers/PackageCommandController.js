    ...
    static uploadPackage(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!PackageData_1.PackageData.isValidUploadOrUpdateRequest(req.body)) {
                Logger_1.Logger.logInfo("Invalid Request: Not correct format");
                res.status(400).json(PackageCommandController.MSG_INVALID);
                return;
            }
            const source = req.body.URL ? req.body.URL : req.body.Content;
            try {
                Logger_1.Logger.logInfo("Creating Package Data Object");
                const packageData = yield PackageData_1.PackageData.create(source, req.body.JSProgram);
                Logger_1.Logger.logInfo("Uploading Package: To S3 and RDS");
                const pack = yield PackageCommandController.packageService.uploadPackage(packageData);
